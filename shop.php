    ...
    header('location:login.php');
     ...
     if(isset($_POST['add_to_cart'])){
      ...
      if(mysqli_num_rows($check_cart_numbers) > 0){
         ...
         mysqli_query($conn, "INSERT INTO `cart`(user_id, name, description, price, image) VALUES('$user_id', '$product_name', '$product_description', '$product_price', '$product_image')") or die ('erreur');
