...
<body>
   ...
   <section class = "add-products">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <input type="text" name="name" class="box" placeholder="enter Nom Produit" required>
        <input type="text" name="description" class="box" placeholder="enter Description Produit" required>
        <input type="number" min="0" name="price" class="box" placeholder="enter Prix Produit" required> >
